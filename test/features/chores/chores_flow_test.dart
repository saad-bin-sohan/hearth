...
void main() {
  ...
  testWidgets('chores tab can add a chore end to end', (
    WidgetTester tester,
  ) async {
    ...
    await tester.tap(find.text('Chores').last);
    ...
    await tester.enterText(find.byType(TextFormField).at(0), 'Sweep kitchen');

    final saveFinder = find.widgetWithText(HearthButton, 'Save Chore');
