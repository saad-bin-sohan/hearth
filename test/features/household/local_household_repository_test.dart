...
void main() {
  test(
    'Household repository enforces unique invite and last admin protection',
    () async {
      ...
      final preview = await householdRepository.previewInvite(
      ...
      expect(
        members
            .singleWhere((HouseholdMember person) => person.userId == member.id)
            .role,
